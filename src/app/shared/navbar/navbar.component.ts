...
export class NavbarComponent implements OnInit {
  topMenuList: string[] = ["Home", "Media", "Blog","Connect Us"]
  ...
  menuObjList = [
    {
      ...
      list: [
        ...
        { name: "Diode Lipolaser", list: [], path: "/diode-lipolaser" },
...

    {
      name: "Body",
      list: [
        { name: "Saggy Skin Treatment", list: [], path: "/saggy-skin-treatment" },
        { name: "Arms Tightening", list: [], path: "/arms-tightening" },
        { name: "Belly Tightening", list: [], path: "/belly-tightening" },
        { name: "Breast Tightening", list: [], path: "/breast-tightening" },
        { name: "Vaginal Tightening", list: [], path: "/vaginal-tightening" },
        {name:"Thighs Tightening",list:[],path:"/thighs-tightening"}
    ...
    },
    {
      ...
      list: [
        ...
        { name: "Anti Ageing / Skin Lifting", list: [], path: "/skin-lifting" },
        { name: "Skin Tightening", list: [], path: "/skin-tightening" },
